...
public class ConsultationController {
    ...
    public TestRequest assignForConsultation(@PathVariable Long id) {
       ...
       // User doc_consultation = userLoggedInService.getLoggedInUser();
      ...
      // TestRequest testRequest = testRequestUpdateService.assignForConsultation(id,doc_consultation);
    ...
    public TestRequest updateConsultation(@PathVariable Long id,@RequestBody CreateConsultationRequest testResult) {
       ...
       //  User update_consul = userLoggedInService.getLoggedInUser();
        // Create an object of the User class to get the logged in us
       // TestRequest testRequest = testRequestUpdateService.updateConsultation();
        ...
        try {
            // replace this line of code with your implementation
            User update_consul = userLoggedInService.getLoggedInUser();
            TestRequest testRequest = testRequestUpdateService.updateConsultation(id,testResult,update_consul);
            return testRequest;
        //    throw new ResponseStatusException(HttpStatus.NOT_IMPLEMENTED,"Not implemented");
